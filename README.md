...
| September 21 | Lecture 2: Data and exploratory analysis<br>`nb02a`: Arrays with NumPy<br>`nb02b`: Arrays with JAX<br>`nb02c`: Data wrangling with Pandas<br>`nb02d`: Exploratory data analysis |
