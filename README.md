...
| October 10 | Lecture 3: Visualization<br>`nb04`: Plots [[notebook](./nb02-plots.ipynb)]<br>`nb05`: Visualizing high-dimensional data<br>Reading: Rougier et al, [Ten Simple Rules for Better Figures](https://journals.plos.org/ploscompbiol/article/file?id=10.1371/journal.pcbi.1003833&type=printable), 2014  |
