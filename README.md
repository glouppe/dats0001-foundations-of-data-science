...
| September 21 | Lecture 2: [Data and exploratory analysis](https://glouppe.github.io/dats0001-foundations-of-data-science/?p=lecture2.md) [[PDF](https://glouppe.github.io/dats0001-foundations-of-data-science/pdf/lec2.pdf)]<br>`nb02a`: Arrays with NumPy [[notebook](./nb02a-tables.ipynb)]<br>`nb02b`: Arrays with JAX [[notebook](./nb02b-jax.ipynb)]<br>`nb02c`: Data wrangling with Pandas [[notebook](./nb02c-data-wrangling.ipynb)]<br>`nb02d`: Exploratory data analysis [[notebook](./nb02d-eda.ipynb)]<br>Reading: Wickham, [Tidy data](https://vita.had.co.nz/papers/tidy-data.pdf), 2014<br>Reading: Gorman et al, [Ecological sexual dimorphism within a community of Antarctic penguins](https://doi.org/10.1371/journal.pone.0090081), 2014 [Methods]<br>Reading: van Buuren, [Flexible Imputation of Missing Data](https://stefvanbuuren.name/fimd/), 2018 [Sections 1.2-1.3] |
...
| October 5 | Lecture 4: Latent variable models<br>`nb04b`: Probabilistic PCA<br>Reading: Blei, [Build, Compute, Critique, Repeat](https://www.cs.columbia.edu/~blei/papers/Blei2014.pdf), 2014 [Sections 1-3] |
