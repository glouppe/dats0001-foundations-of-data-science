...
| October 24 | Lecture 5: Approximate Bayesian inference (part 1)<br>Sidenotes: Expectation-Maximization [[PDF](./pdf/lec05-sidenotes.pdf)]<br>`nb07`: Expectation-Maximization [[notebook](./nb07-em.ipynb)]<br>Reading: Dempster et al, [Maximum Likelihood from Incomplete Data via the EM Algorithm](https://www.jstor.org/stable/2984875), 1977 |
| October 31 | Homework 1: [Explore the Argo data](https://github.com/glouppe-teaching/dats0001-hw1)
| November 7 | Lecture 6: Approximate Bayesian inference (part 2)<br>`nb08`: Variational inference<br>Reading: Blei et al, [Variational inference: A review for Statisticians](https://arxiv.org/abs/1601.00670), 2016  |
| November 14 | Lecture 7: Approximate Bayesian inference (part 3)<br>`nb09`: Markov Chain Monte Carlo |
