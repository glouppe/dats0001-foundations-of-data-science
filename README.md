...
| October 6 | Lecture 4: [Latent variable models](https://glouppe.github.io/dats0001-foundations-of-data-science/?p=lecture4.md) [[PDF](https://glouppe.github.io/dats0001-foundations-of-data-science/pdf/lec4.pdf)]<br>`nb04b`: [Probabilistic PCA](./nb04b-ppca.ipynb)<br> 
Reading: Blei, [Build, Compute, Critique, Repeat](http://www.cs.columbia.edu/~blei/fogm/2020F/readings/Blei2014.pdf), 2014 [Sections 1-3] |
