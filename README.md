...
| October 5 | Lecture 4: Latent variable models<br>`nb04a`: Gaussian model<br>`nb04b`: Probabilistic PCA<br>Reading: Blei, [Build, Compute, Critique, Repeat](https://www.cs.columbia.edu/~blei/papers/Blei2014.pdf), 2014 [Sections 1-3]<br>Reading: Gelman, Vehtari, McElreath et al, [Bayesian Workflow](https://avehtari.github.io/Bayesian-Workflow/), 2026 [Chapter 19]<br>Reading: Hogg, Bovy & Lang, [Data analysis recipes: Fitting a model to data](https://arxiv.org/abs/1008.4686), 2010 [Sections 1-3] |
